...
export default function Submissions() {
  ...
  const isFormValid = consentChecked && gender !== "" && industry !== "" && hasAge;
            ...
            <div className="space-y-3">
              <label className="flex cursor-pointer items-start gap-3">
                ...
                <span className="text-sm leading-relaxed text-gray-600">
                  Check here if you consent to us reading (or paraphrasing) your
                  question on the Work Wife Podcast.{" "}
                  <span className="text-ww-orange">*</span>
                </span>
              </label>
              <p className="text-xs italic leading-relaxed text-gray-400">
                By clicking below, I acknowledge that I am voluntarily providing
                my consent and release to Work Wife, its members, officers,
                directors, employees, contractors and assigns to use any and all
                details from this submission for any purpose, including, but not
                limited to, the right to use such story for content for the Work
                Wife podcast and social media platforms, and to monetize and
                exploit such content commercially. I hereby release and hold
                harmless Work Wife, its members, officers, directors, employees,
                contractors and assigns against all claims, damages or expenses
                of whatever form or nature, including attorneys&apos; fees and
                other costs of legal defense, whether direct or indirect, that
                they may sustain or incur as a result of the use of this content
                and release any claims by or on behalf of myself and my heirs
                for any damages or reimbursement for use of the content.
              </p>
            </div>
